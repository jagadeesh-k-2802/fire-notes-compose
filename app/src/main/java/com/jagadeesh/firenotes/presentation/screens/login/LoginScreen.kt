package com.jagadeesh.firenotes.presentation.screens.login
...
fun LoginScreen(navController: NavController) {
        ...
        if (email.isEmpty() || password.isEmpty()) {
            ...
            scope.launch {
                try {
                    ...
                    scope.launch { snackbarHostState.showSnackbar("Login Error") }
                }
            }
        }
    }
    ...
    Scaffold(
        topBar = { AppBar(title = Screens.LoginScreen.title) },
